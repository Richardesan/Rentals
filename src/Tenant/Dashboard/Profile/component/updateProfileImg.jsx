...
import { updateAvatar } from "../../../../services/queries";
import { toast } from "react-toastify";
import { useAuth } from "../../../../context/authContext";
const UpdateProfileImg = ({ isOpen, onClose, setReload, user, myImg }) => {
...
const uploadAvatar = async () => {
  ...
  try {
    const data = await updateAvatar(formData, token); // Pass formData directly
    console.log(data);
